import { c as createLucideIcon, u as useNavigate, b as useGetEnrollments, a as useGetCourses, $ as SAMPLE_COURSES, j as jsxRuntimeExports, L as Layout, f as LoadingSpinner, v as BookOpen, B as Badge, D as DIFFICULTY_LABELS, P as ProgressBar, t as Clock, e as Button, p as Link, z as Award } from "./index-Duog9_D-.js";
...
function MyCoursesPage() {
  ...
  const enrolledCourses = (enrollments ?? []).map((e) => {
    const course = (allCourses ?? []).find((c) => c.id === e.courseId) ?? SAMPLE_COURSES.find((c) => c.id === e.courseId);
