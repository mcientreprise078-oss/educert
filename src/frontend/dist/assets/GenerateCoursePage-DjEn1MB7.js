import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, u as useNavigate, aM as useRequestGeneration, aN as useListMyGenerations, aO as useGetGenerationStatus, al as useGetAdminModelConfig, L as Layout, ak as Sparkles, I as Input, e as Button, B as Badge, v as BookOpen, h as ue, aP as useSearchWorldLibraries, aQ as LIBRARY_SOURCE_ORDER, t as Clock, Y as ArrowRight } from "./index-Duog9_D-.js";
import { C as Card, a as CardContent, b as CardHeader } from "./card-CITtkol-.js";
...
const BookText = createLucideIcon("book-text", __iconNode$2);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function buildStepConfig(config) {
  return [
    {
      step: 1,
      model: config.structureModel,
      label: "Structure du cours",
      description: "Analyse des ressources et définition de la structure pédagogique",
      color: "text-primary",
...
function SuggestionChips({ onSelect }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: SUGGESTION_CHIPS.map((chip, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    "button",
    {
      type: "button",
...
function LibraryResultCard({ result }) {
  const colorClass = SOURCE_COLORS[result.source] ?? "bg-muted text-muted-foreground border-border";
  const Icon = SOURCE_ICONS[result.source] ?? BookOpen;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3 p-3 rounded-lg bg-muted/30 border border-border hover:bg-muted/50 transition-smooth group", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-foreground line-clamp-1 group-hover:text-primary transition-colors", children: result.title }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "a",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(ExternalLink, { className: "size-3 text-muted-foreground" })
      }
    )
  ] });
}
function WorldLibrarySection({
  ...
  const { data: results = [], isLoading } = useSearchWorldLibraries(
    shouldSearch ? { query: description, domain: domain || void 0 } : null
  );
  if (!shouldSearch) return null;
  const grouped = LIBRARY_SOURCE_ORDER.reduce((acc, src) => {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-foreground", children: "Sources mondiales" })
          ] }),
          isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-muted-foreground flex items-center gap-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "size-3 animate-spin" }),
            "Consultation des bibliothèques…"
          ] }) : hasResults ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-medium text-primary bg-primary/10 px-2 py-0.5 rounded-full", children: [
            results.length,
            " ressource",
            results.length > 1 ? "s" : "",
            " trouvée",
        ...
        isLoading && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 gap-2", children: [1, 2, 3].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-14 w-full rounded-lg" }, i)) }),
        !isLoading && hasResults && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
            ...
            " ",
            "dans les bibliothèques mondiales — consultées automatiquement pour enrichir votre formation."
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: LIBRARY_SOURCE_ORDER.map((source) => {
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-1.5", children: items.map((r) => /* @__PURE__ */ jsxRuntimeExports.jsx(LibraryResultCard, { result: r }, r.id)) })
                ]
              },
              source
            );
        ...
        !isLoading && !hasResults && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 py-3 text-xs text-muted-foreground", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Library, { className: "size-4 shrink-0" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Les bibliothèques mondiales seront consultées lors de la génération." })
        ] })
      ]
    }
  );
...
function StepItem({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-4", "data-ocid": `generate_course.step.${stepNum}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          className: `w-9 h-9 rounded-full flex items-center justify-center shrink-0 border-2 transition-smooth ${state === "done" ? `${iconBgDone} border-transparent` : state === "active" ? `${iconBgActive} border-transparent` : "bg-muted text-muted-foreground border-border"}`,
          children: state === "done" ? /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "size-4" }) : state === "active" ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "size-4 animate-spin" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "size-4 opacity-50" })
        }
      ),
      !isLast && /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          className: `w-0.5 flex-1 my-1 rounded-full min-h-[2rem] transition-smooth ${state === "done" ? "bg-primary/30" : "bg-border"}`
        }
      )
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: `flex-1 p-3 rounded-xl border mb-3 transition-smooth ${state === "active" ? bgActive : state === "done" ? bgDone : "bg-muted/30 border-transparent"}`,
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 mb-0.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "span",
                {
                  className: `text-xs font-bold uppercase tracking-widest ${state !== "idle" ? color2 : "text-muted-foreground"}`,
                  children: [
                    "Étape ",
                    step
                  ]
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "span",
                {
                  className: `text-xs font-semibold ${state !== "idle" ? color2 : "text-muted-foreground"}`,
                  children: [
                    "via ",
                    model
                  ]
          ...
          state === "active" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "shrink-0 mt-0.5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1 text-xs font-medium px-2 py-0.5 rounded-full bg-primary/15 text-primary", children: [
    ...
    motion.div,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border-primary/20", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "pt-0 px-4 pb-3 space-y-1.5", children: [
            resourceCount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-xs text-muted-foreground", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Library, { className: "size-3.5" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-foreground", children: resourceCount }),
                " ",
                "ressource",
                resourceCount > 1 ? "s" : "",
            ...
            (gen.libraryResultsCount ?? 0) > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-xs text-muted-foreground", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Globe, { className: "size-3.5 text-primary" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-foreground", children: gen.libraryResultsCount }),
                " ",
        ...
        !isTerminal || gen.status === "approved" ? /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "pt-5 px-4 pb-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: steps.map((cfg, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            StepItem,
            {
              ...cfg,
              stepNum: cfg.step,
        ...
        gen.status === "queued" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 p-4 rounded-xl bg-muted/60 border border-border", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Votre demande est enregistrée. L'IA commencera l'analyse sous peu." })
          ] })
        ] }),
        gen.status === "approved" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold", children: "Votre formation est prête !" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm opacity-90", children: [
                "Votre cours a été validé et approuvé par",
                " ",
                ((_a = gen.aiModelConfig) == null ? void 0 : _a.validationModel) ?? modelConfig.validationModel,
                ". Il est maintenant disponible dans votre espace d'apprentissage."
              ] }),
              resourceCount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs opacity-80 flex items-center gap-1.5", children: [
        ...
        gen.status === "rejected" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            initial: { opacity: 0, scale: 0.97 },
            animate: { opacity: 1, scale: 1 },
            ...
            children: [
              ...
              gen.errorMessage && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 rounded-lg bg-destructive/5 border border-destructive/15", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs font-medium text-muted-foreground mb-1", children: [
                  "Motif du rejet (",
                  ((_b = gen.aiModelConfig) == null ? void 0 : _b.validationModel) ?? modelConfig.validationModel,
                  ") :"
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-foreground", children: gen.errorMessage })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Reformulez votre demande en étant plus précis, ou ajoutez plus de contexte pour améliorer les résultats." }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Button,
                {
                  size: "sm",
        ...
        gen.status === "revision_needed" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            initial: { opacity: 0, scale: 0.97 },
            animate: { opacity: 1, scale: 1 },
            ...
            children: [
              ...
              gen.errorMessage && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 rounded-lg bg-accent/5 border border-accent/15", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-medium text-muted-foreground mb-1", children: "Notes du réviseur :" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-foreground", children: gen.errorMessage })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Button,
...
function GenerateCoursePage() {
  ...
  const [debouncedDescription, setDebouncedDescription] = reactExports.useState("");
  ...
  const handleFileChange = (e) => {
    ...
    if (!allowed.includes(file.type)) {
      ue.error("Seuls les fichiers PDF et Word sont acceptés.");
      return;
    }
    setAttachedFile(file);
    ue.success(`Fichier joint : ${file.name}`);
  };
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display font-bold text-3xl text-foreground leading-tight", children: "Que souhaitez-vous apprendre ?" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm max-w-lg mx-auto leading-relaxed", children: "Notre IA recherche dans des milliers de livres, vidéos et ressources des bibliothèques mondiales pour créer votre formation personnalisée." }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center gap-1 pt-1", children: [
                config.structureModel,
                config.contentModel,
                config.validationModel
              ].map((model, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold px-2 py-0.5 rounded-full bg-muted border border-border text-muted-foreground", children: model }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", children: showForm && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            className: "space-y-4",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "shadow-card", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "pt-5 space-y-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "label",
                    {
                      ...
                      children: "Décrivez votre formation"
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Textarea,
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground mt-1.5 flex items-center justify-between", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Plus vous êtes précis, meilleur sera le résultat." }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "span",
                      {
                        className: description.trim().length < 20 ? "text-muted-foreground" : "text-primary font-medium",
                        children: [
                          description.length,
                          " car."
                        ]
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "label",
                    {
                      ...
                      children: [
                        ...
                        " ",
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground/70", children: "(optionnel)" })
                      ]
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Button,
                  {
                    ...
                    disabled: requestGeneration.isPending || description.trim().length < 20,
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: debouncedDescription.trim().length >= 10 && /* @__PURE__ */ jsxRuntimeExports.jsx(
                motion.div,
                {
                  initial: { opacity: 0, y: 8 },
                  animate: { opacity: 1, y: 0 },
                  exit: { opacity: 0 },
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "border-primary/15 bg-card", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "pt-4 px-4 pb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                    WorldLibrarySection,
                    {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(SuggestionChips, { onSelect: (text) => setDescription(text) })
              ] })
            ]
          },
          "form"
        ...
        historyItems.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold uppercase tracking-widest text-muted-foreground mb-3", children: "Mes générations précédentes" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: historyItems.map((gen, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  type: "button",
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-2", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-foreground line-clamp-2 flex-1 group-hover:text-primary transition-colors", children: gen.requestDescription }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        Badge,
                        {
                          variant: gen.status === "approved" ? "default" : gen.status === "rejected" ? "destructive" : "secondary",
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mt-1.5 flex-wrap", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: new Date(gen.createdAt).toLocaleDateString("fr-FR", {
                        day: "numeric",
                        month: "long",
                        year: "numeric"
                      }) }),
                      gen.resourceIds.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-muted-foreground flex items-center gap-1", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(Library, { className: "size-3" }),
                        gen.resourceIds.length,
                        " ressource",
                        gen.resourceIds.length > 1 ? "s" : ""
                      ] }),
                      (gen.libraryResultsCount ?? 0) > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-primary flex items-center gap-1", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(Globe, { className: "size-3" }),
                        gen.libraryResultsCount,
                        " livre",
                        (gen.libraryResultsCount ?? 0) > 1 ? "s" : "",
                        " de bibliothèques inclus"
                      ] })
                    ] })
                  ]
                },
