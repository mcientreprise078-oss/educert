import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, L as Layout, v as BookOpen, at as useIndexResourceText, ao as useListResources, e as Button, I as Input, au as FileText, B as Badge, T as Trash2, i as useListExternalCourses, k as useTrackExternalCourseView, h as ue, av as useImportGoogleDoc, ad as Label, aw as useUploadResource, ax as useUpdateResourceMetadata, ay as useDeleteResource, az as useAddExternalCourse, aA as useDeleteExternalCourse } from "./index-D09cs5UV.js";
...
function GoogleDocsImportPanel() {
  ...
  const [docUrl, setDocUrl] = reactExports.useState("");
  const [title, setTitle] = reactExports.useState("");
  const handleImport = () => {
    if (!docUrl.trim()) {
      ue.error("L'URL du document est requise");
      return;
    }
    if (!title.trim()) {
      ue.error("Le titre du document est requis");
      return;
    }
    importGoogleDoc.mutate(
      ...
      {
        onSuccess: () => {
          ue.success("Document importé avec succès");
          setDocUrl("");
          setTitle("");
        },
        onError: () => ue.error("Erreur lors de l'importation du document")
      }
    );
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    Card,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "text-sm font-semibold flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-7 h-7 rounded-lg bg-primary/10 flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(FileUp, { className: "size-3.5 text-primary" }) }),
          "Importer depuis Google Docs"
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "gdoc-url", children: "URL du document Google Docs" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                id: "gdoc-url",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "gdoc-title", children: "Titre du document" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                id: "gdoc-title",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              ...
              children: importGoogleDoc.isPending ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(RefreshCw, { className: "size-3.5 animate-spin" }),
                "Importation..."
              ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(FileUp, { className: "size-3.5" }),
...
function ResourcesTab() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(GoogleDocsImportPanel, {}),
