import { c as createLucideIcon, r as reactExports, E as useDirection, F as useControllableState, j as jsxRuntimeExports, H as Primitive, a0 as useId, R as Root, K as Item, M as composeEventHandlers, O as Presence, N as createRovingFocusGroupScope, Q as createContextScope, q as cn, u as useNavigate, a1 as useGetCertificates, L as Layout, z as Award, t as Clock, e as Button, a2 as Shield, B as Badge, v as BookOpen, a3 as ChevronDown, h as ue } from "./index-Duog9_D-.js";
    ...
    "article",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-5 flex flex-col gap-4 flex-1", children: [
          ...
          ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 px-3 py-2.5 bg-accent/8 border border-accent/20 rounded-lg", children: [
...
function CertificatesGrid({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: certs.map((cert, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(CertificateCard, { cert, index: i + 1 }, cert.id))
    }
  );
}
